...
export default function TitleBar({ onOpenSettings, showSearch, onToggleSearch, lang, collapsed, onToggleCollapse, trashCount = 0, onOpenTrash, onOpenExport }) {
          ...
          <div className="help-popover-list">
            <div className="help-item top">
              ...
              <div className="help-item-content">
                ...
                <div className="help-sub-item">{lang === "zh" ? "提前提醒：单次任务可设提前N分钟通知" : "Advance: Set N-minute early alert for once tasks"}</div>
              </div>
            </div>
            ...
            <div className="help-item">
              ...
              <span>{lang === "zh" ? "编辑：点铅笔编辑，回车保存" : "Edit: Pencil to edit, Enter to save"}</span>
            </div>
            <div className="help-item">
              <svg className="help-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
            ...
            <div className="help-item">
              ...
              <span>{lang === "zh" ? "导出完成记录：下载图标→选日期范围→按日分组展示已完成任务，支持复制文本或保存文件" : "Export: Download icon → pick date range → grouped by day, copy or save as file"}</span>
            </div>
          </div>
