...
export default function TitleBar({ onOpenSettings, showArchive, onToggleArchive, archivedCount }) {
  ...
  return (
    <div id="titlebar" data-tauri-drag-region>
      ...
      <div id="title-controls">
        <button
          className={"title-btn" + (showArchive ? " active" : "")}
          id="archive-btn"
        ...
        >
          ...
          {archivedCount > 0 && !showArchive && (
            <span id="archive-badge">{archivedCount}</span>
          )}
        </button>
